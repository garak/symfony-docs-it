...
mentre la seconda viene considerata solo dalla cache
condivise::
...
Come le impronte digitali, ogni ``ETag`` deve essere univoco tra tutte le rappresentazioni della stessa risorsa.
