...
è detta :ref:`nome logico<controller-string-syntax>`. Segue uno
schema che punta a un specifico classe e metodo PHP:
...
.. code-block:: php
    ...
    class BlogController extends Controller
    {
        ...
        {
            $blog = // usare la variabile $slug per interrogare la base dati
...
In una sezione successiva, si imparerà a generare URL dall'interno di template.
