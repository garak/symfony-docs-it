...
.. tip::
    ...
    per il ramo `2.2`, la patch sarà applicata anche sul ramo
    `master`.
...
.. tip::
    ...
    Si faccia attenzione a puntare la richiesta di pull verso ``symfony:2.2``, se si vuole
    che la risoluzione del bug riceva un pull basato sul ramo 2.2.
